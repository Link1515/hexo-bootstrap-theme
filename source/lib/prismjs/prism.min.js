/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+apacheconf+aspnet+bash+c+csharp+cpp+css-extras+csv+dart+django+docker+ejs+git+go+go-module+graphql+handlebars+ini+java+javadoc+javadoclike+jsdoc+json+json5+kotlin+lua+makefile+markup-templating+nginx+objectivec+php+phpdoc+php-extras+powershell+python+cshtml+jsx+tsx+regex+ruby+rust+scss+sql+swift+twig+typescript+vim+xml-doc+yaml&plugins=line-highlight+line-numbers+show-language+inline-color+toolbar+copy-to-clipboard */
